...
// InfBez1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CInfBez1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CInfBez1App

CInfBez1App::CInfBez1App()
{
...
// Единственный объект CInfBez1App

CInfBez1App theApp;


// Инициализация CInfBez1App

BOOL CInfBez1App::InitInstance()
{
